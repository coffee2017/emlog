...
class User_Model {
    ...
    function addUser($login, $password,  $role, $ischeck, $email) {
        $sql="insert into ".DB_PREFIX."user (username,password,role,ischeck,email) values('$login','$password','$role','$ischeck','$email')";
        $this->db->query($sql);
    }
